...
def compare_hf_template_with_renderer(repo_name, template_name, messages=None, tools=None, add_generation_prompt=False, **kwargs):
    from .. import Chat
    chat = Chat(template_name, messages=messages)
    chat_hf_template = Chat(repo_name, messages=messages)

    implemented_prompt = chat.prompt(add_generation_prompt=add_generation_prompt, tools=tools, **kwargs)
    implemented_hf_template_prompt = chat_hf_template.prompt(add_generation_prompt=add_generation_prompt, tools=tools, **kwargs)
    is_equal = implemented_prompt == implemented_hf_template_prompt
    highlighted_prompt = chat.prompt_with_mask(add_generation_prompt=add_generation_prompt, tools=tools, **kwargs)
    highlighted_hf_template_prompt = chat_hf_template.prompt_with_mask(add_generation_prompt=add_generation_prompt, tools=tools, **kwargs)
    is_equal_between_implemented_and_highlighted_hf_template_prompts = implemented_prompt == highlighted_hf_template_prompt
    return is_equal, is_equal_between_implemented_and_highlighted_hf_template_prompts, implemented_prompt, implemented_hf_template_prompt, highlighted_prompt, highlighted_hf_template_prompt
